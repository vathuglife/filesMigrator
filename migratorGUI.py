...
class notification(Label):
    def __init__ (self,promptText,iconVar,iconPos,textPos,duration,**kwargs):
        ...
        self.ico = MDIcon(icon=iconVar,size_hint=(None,None),width=70,height=70,
                            pos=iconPos)
        self.notif = Label(text=promptText,font_size=30,
...
class allDirScreen(Screen):
    def on_enter(self,*args):
        ...
        self.scroll = ScrollView(size_hint=(None,None),size=(760,330),
        ...
        self.scroll.add_widget(displayList)

        
        self.add_widget(self.scroll)
    def on_pre_leave(self,*args):
        self.remove_widget(self.scroll) #Remove and re_add the directory list on_enter, as a form of refreshing the list (if updated with new Dir)
        #self.add_widget(self.scroll)
...
class addDirScreen(Screen):
    ...
    def add(self,*args):
        ...
        if (os.path.isdir(newDir) == 0):
            notif = notification("Invalid input. Please try again!",'x-button2.png',(75,75),(320,58))
            ...
            for directory in self.dirs:
                if directory == newDirJson:
                    notif = notification("Duplicated Directory found! Please try again.",'x-button2.png',(75,85),(420,68))
                    self.add_widget(notif)
                    return 0
...
class changeDestScreen(Screen):
    def on_enter(self,*args):
        ...
        self.inputDest = TextInput(font_size=30,pos=(160,258),
                          size_hint=(None,None),width=650,height=50,font_name='Quicksand',
                          multiline=False,background_color=(1/255,1/255,1/255,0),
